...
class ScorecardGenerator {
  ...
  generate(finalScore, home, away, homeScore, awayScore, homeURI, awayURI, time, quarter, possession) {
  ...
  _teamSection(home, away, homeScore, awayScore, homeURI, awayURI, padding, finalScore) {
    const nameSize = 40;
    const scoreSize = 60;
    const teamNameX = 220;
...
exports.default = ScorecardGenerator;