...
const messenger = new _messengerApi.default();
...
async function sendScoreCard(final, team1, team2, team1Score, team2Score, team1Image, team2Image, time, quarter, possession) {
  try {
    const cardPath = await gen.generate(final, team1, team2, team1Score, team2Score, team1Image, team2Image, time, quarter, possession);
...
sendScoreCard(final, team1, team2, team1Score, team2Score, team1Image, team2Image, time, quarter, possession); // sendScore(team1, team2, team1Score, team2Score, play);
